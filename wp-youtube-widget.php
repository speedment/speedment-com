...
class YouTube_Widget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		<div class="youtube col-md-4 col-sm-6 col-xs-12">
			...
			<iframe src="https://www.youtube.com/embed/<?php echo $videoId; ?>" width="640" height="360" frameborder="0" style="position:absolute;width:100%;height:100%;left:0" allowfullscreen></iframe>
		</div>
