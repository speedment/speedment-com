...
<div class="row justify-content-center" id="sql-java-examples">
    <div class="container full-width-product-view">
        ...
        <div class="row px-5 px-md-0 justify-content-center">
            <!-- Count Tab -->
    ...
    <div class="container">
        <div class="row justify-content-center py-4">
            <div class="col-lg-7 mt-3 mb-2">
                ...
                <p>Speedment Stream is now capable of generating a complete Spring Boot REST API (including all CRUD operators) for your database. It is ready for deployment in minutes.</p>
            </div>
            <div class="col-lg-5 text-centered my-3">
                <div class="oracle-frame">
                    <img class="align-vertical" src="https://speedment.com/wp-content/uploads/2020/02/spring-generation.png" width="90%" data-aos="fade-up">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container full-width-product-view">
        <div class="row justify-content-center py-3">
            ...
            <div class="col py-5 px-5 px-md-0">
                ...
                <a href="https://speedment.github.io/speedment-doc/index" target="_blank" class="btn btn-secondary-white ml-2">Documentation</a>
            </div>
            <div class="col-2 d-none d-md-block"></div>
        </div>
    </div>
