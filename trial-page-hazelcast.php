    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col" style="text-align: left; font-size: 1.5em">
                Use the Initializer to configure your project. Once launching the tool you can choose between a
        ...
        <div class="row justify-content-center gray-area">
            <div class="col-md-6 col-sm-12 config-column">
                <div class="row">
                    <div class="col hazel-cast-title-area">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <img class="hazelcast-logo" width="90%"
                                     src="https://speedment.com/wp-content/uploads/2019/06/hazelcast-logo-and-text.png">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group-submit row" id="submitGroup">
                    <div class="col-4">
                        <img class="powered-by-speedment" width="90%"
                             src="https://speedment.com/wp-content/uploads/2019/06/Powered-by-Speedment-black.png"
                             alt="Powered by Speedment">
                    </div>
                    <div class="col-8 download-btn-area">
            ...
            <div class="col-md-6 col-sm-12 preview-column hazelcast-code">
                ...
                <div class="tab-pane active" id="fileMaven" role="tabpanel">
                    <pre class="preview"><code class="language-xml" class="hazelcast-preview" id="previewMaven"></code></pre>
                </div>
            </div>
